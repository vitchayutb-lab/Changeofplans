...
export interface BotSeriesDescriptor {
  ...
  /**
   * อ่านทุกคอลัมน์ที่ตรงในแถวแล้วเฉลี่ยรวมกัน แทนที่จะใช้คอลัมน์แรกที่เจอ
   *
   * ใช้กับชุดที่ ธปท. ประกาศเป็นช่วง เช่น เงินฝากที่ให้มาเป็น _min กับ _max
   * ค่าที่ได้จึงเป็นจุดกึ่งกลางของช่วง ไม่ใช่ขอบใดขอบหนึ่งซึ่งจะสูงหรือต่ำเกินจริง
   */
