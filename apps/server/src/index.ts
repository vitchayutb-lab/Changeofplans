...
// วางคีย์ทั้งวงเล็บของตัวอย่างมาด้วยเป็นสาเหตุที่เจอบ่อยของ 403 ที่อ่านไม่ออก
// ระบบตัดให้แล้ว แต่ต้องบอก เพราะแปลว่าค่าที่เก็บไว้ยังผิดอยู่และจะงงกันอีกรอบ
if (env.botApiKeyWrapper) {
  console.warn(
    `\n⚠️  BOT_API_KEY มีอักขระ ${env.botApiKeyWrapper} ครอบอยู่ — ระบบตัดออกให้แล้วสำหรับรอบนี้\n` +
      '    แต่ควรแก้ค่าที่เก็บไว้ให้เหลือแค่คีย์ล้วน ๆ\n',
  );
}
