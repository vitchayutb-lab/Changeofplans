 ...
 * หกสีไม่พอแล้ว
 *
 * BIBOR มีแปดช่วงอายุ และอัตราระหว่างธนาคารมีมากกว่าสิบช่วง เส้นที่เกินจำนวนสีจะวน
 * กลับมาใช้สีซ้ำ ทำให้อ่านกราฟไม่ออกว่าเส้นไหนคืออะไร สี่สีท้ายจึงเติมเข้ามาให้ครบสิบ
 */
const PALETTE = [
  '#1d4ed8',
  '#0d9488',
