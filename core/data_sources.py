...
_FALLBACK_QUOTES: dict[str, dict[str, float]] = {
    ...
    "MYRO": {"price": 0.0890, "market_cap": 89_000_000, "volume_24h": 14_000_000},
    "PONKE": {"price": 0.3100, "market_cap": 68_000_000, "volume_24h": 12_000_000},
    "NEIRO": {"price": 0.00190, "market_cap": 265_000_000, "volume_24h": 120_000_000},
    # --- สายแมว ---
    ...
    "MICHI": {"price": 0.1350, "market_cap": 132_000_000, "volume_24h": 18_000_000},
    # --- สายกบ ---
    "PEPE": {"price": 0.00001180, "market_cap": 4_960_000_000, "volume_24h": 1_120_000_000},
    "BRETT": {"price": 0.1450, "market_cap": 1_440_000_000, "volume_24h": 165_000_000},
    "TURBO": {"price": 0.00620, "market_cap": 425_000_000, "volume_24h": 78_000_000},
    # --- สัตว์อื่น ---
    "PNUT": {"price": 0.7900, "market_cap": 790_000_000, "volume_24h": 340_000_000},
    "MOODENG": {"price": 0.2450, "market_cap": 245_000_000, "volume_24h": 88_000_000},
    "GOAT": {"price": 0.6400, "market_cap": 640_000_000, "volume_24h": 145_000_000},
    # --- คลาสสิก / อื่น ๆ ---
    "MOG": {"price": 0.00000185, "market_cap": 720_000_000, "volume_24h": 95_000_000},
    "SPX": {"price": 0.8200, "market_cap": 765_000_000, "volume_24h": 62_000_000},
    "BOME": {"price": 0.00780, "market_cap": 545_000_000, "volume_24h": 130_000_000},
    "TOSHI": {"price": 0.00108, "market_cap": 415_000_000, "volume_24h": 45_000_000},
    "DEGEN": {"price": 0.00840, "market_cap": 155_000_000, "volume_24h": 22_000_000},
    "SLERF": {"price": 0.1650, "market_cap": 68_000_000, "volume_24h": 21_000_000},
    "WEN": {"price": 0.00009800, "market_cap": 82_000_000, "volume_24h": 9_000_000},
    "LADYS": {"price": 0.00000012, "market_cap": 62_000_000, "volume_24h": 8_000_000},
    "BILLY": {"price": 0.0480, "market_cap": 48_000_000, "volume_24h": 6_000_000},
}

# ลักษณะเฉพาะของแต่ละเหรียญในโหมดจำลอง: (beta เป้าหมาย, ความผันผวนเฉพาะตัวต่อวัน, drift ต่อวัน)
# หลักการตั้งค่า: เหรียญมาร์เก็ตแคปเล็กและใหม่กว่า มักมี β และความผันผวนสูงกว่า
_COIN_CHARACTER: dict[str, tuple[float, float, float]] = {
    ...
    "MYRO": (2.75, 0.082, -0.0038),
    "PONKE": (2.90, 0.088, -0.0025),
    "NEIRO": (2.45, 0.074, 0.0016),
    # --- สายแมว ---
    "POPCAT": (2.60, 0.071, 0.0030),
    "MEW": (2.20, 0.066, 0.0011),
    "MICHI": (2.85, 0.086, -0.0018),
    # --- สายกบ ---
    "PEPE": (2.35, 0.062, 0.0038),
    "BRETT": (2.15, 0.059, 0.0022),
    "TURBO": (2.50, 0.076, 0.0008),
    # --- สัตว์อื่น ---
    "PNUT": (2.70, 0.079, 0.0034),
    "MOODENG": (2.95, 0.091, 0.0019),
    "GOAT": (2.80, 0.084, 0.0027),
    # --- คลาสสิก / อื่น ๆ ---
    "MOG": (2.30, 0.068, 0.0021),
    "SPX": (1.95, 0.056, 0.0041),
    "BOME": (2.55, 0.077, -0.0014),
    "TOSHI": (2.10, 0.061, 0.0013),
    "DEGEN": (2.65, 0.080, -0.0029),
    "SLERF": (3.05, 0.094, -0.0042),
    "WEN": (2.75, 0.083, -0.0033),
    "LADYS": (2.40, 0.072, -0.0011),
    "BILLY": (3.10, 0.097, -0.0036),
}
