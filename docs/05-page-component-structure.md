...
| `/debt-outlook` | `DebtOutlookPage` | How many years before it stops being affordable — DSCR projected across scenarios against the real amortization of existing facilities |
...
| `/funding-strategy` | `FundingStrategyPage` | Where to raise money from and in what order — starting with cash already tied up in the business |
